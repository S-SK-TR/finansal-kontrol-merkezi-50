          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              ...
              <div className="flex gap-3">
                <button className="px-4 py-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl text-sm font-medium transition-colors">
                  Rapor Al
                </button>
                <button 
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <StatCard 
                title="Aylık Gider" 
                amount={`₺${monthlyExpense.toLocaleString()}`} 
                change="-8.4%" 
                down 
